...
public class LeftMenuFragment extends AbstractAppFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        layout.drafts = (Button) view.findViewById(R.id.btn_drafts);
...
//        layout.location.setOnClickListener(onClickListener);
        layout.drafts.setOnClickListener(onClickListener);
...
//        layout.setting.setBackgroundResource(R.color.transparent);
        layout.drafts.setBackgroundResource(R.drawable.btn_drawer_menu);
